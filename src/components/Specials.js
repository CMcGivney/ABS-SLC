...
<div className='homeContent'>
 ...
 <div className="mainText">
  ...
  <Header.Content as="h5" >2 – 6oz <a target="_blank" rel="noopener noreferrer" href="https://www.kvaroyarctic.com/salmon" className="aContent">Kvaroy Premium Arctic Salmon</a> (Hands down the best Salmon we have ever tasted)</Header.Content>
